...
open class CornerGradientView: UIView
{
  ...
  {
    gradientLayer!.colors = [UIColor(red: 255/255.0, green: 167/255.0, blue: 255/255.0, alpha: 1.0).cgColor, UIColor(red: 242/255.0, green: 167/255.0, blue: 252/255.0, alpha: 1.0).cgColor]
  }
  /**
   Step 2
   */
